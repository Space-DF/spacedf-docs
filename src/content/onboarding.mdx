...
<Cards>
  <Cards.Card icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 2L2 7v10l10 5 10-5V7l-10-5z" stroke="currentColor" strokeWidth="2" fill="none"/><circle cx="12" cy="12" r="3" fill="currentColor"/></svg>} title="Manual Entry" href="/devices">
    Add single devices manually with DevEUI, JoinEUI, and App Key
  </Cards.Card>
  <Cards.Card icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="16" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/><path d="M7 8h10M7 12h6M7 16h4" stroke="currentColor" strokeWidth="1.5"/></svg>} title="CSV Import" href="/devices">
    Bulk import multiple devices using CSV file format
  </Cards.Card>
  <Cards.Card icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="4" y="4" width="16" height="16" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/><rect x="9" y="9" width="6" height="6" rx="1" stroke="currentColor" strokeWidth="2" fill="none"/></svg>} title="QR Code Scan" href="/devices">
...
1. **Explore Dashboard Features**: Learn about [dashboard customization](/spaces)
2. **Set Up Organizations**: Configure [user roles and permissions](/organizations)
3. **Configure Spaces**: Create [multiple spaces](/spaces) for different locations
4. **API Integration**: Connect with your applications using our [APIs](/api-reference)
...
- **[Device Documentation](/devices)** - Detailed device management guides
