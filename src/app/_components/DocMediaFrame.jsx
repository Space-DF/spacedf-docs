/**
 * Frames documentation media (images/videos) in a rounded “app window” shell.
 */
export function DocMediaFrame({children, className = ""}) {
  return (
    <div
    ...
    >
      ...
      <div className="p-1.5 sm:p-2">
        <div className="overflow-hidden rounded-lg bg-white ring-1 ring-zinc-200/80 dark:bg-zinc-900/60 dark:ring-zinc-700/80 [&_img]:block [&_img]:h-auto [&_img]:w-full [&_img]:align-middle [&_video]:block [&_video]:h-auto [&_video]:w-full [&_video]:align-middle">
          {children}
        </div>
      </div>
    </div>
